...
As the game has spread, numerous variations have developed. I will describe a typical basic version first, and list some variations at the end. As the variations are so numerous, I have tried to group them into types for easier reference.`,
  zones: [
    ...
    { id: 'p-north', anchor: { x: 0.5, y: 0.16 }, layout: 'pile', rotate: 180, label: 'North', labelPos: 'below' },
    { id: 'p-west', anchor: { x: 0.13, y: 0.5 }, layout: 'pile', label: 'West', labelPos: 'above' },
    { id: 'p-east', anchor: { x: 0.87, y: 0.5 }, layout: 'pile', label: 'East', labelPos: 'above' },
    { id: 'p-south', anchor: { x: 0.5, y: 0.82 }, layout: 'fan', gap: 0.03, label: 'You', labelPos: 'above' },
    { id: 'trick', anchor: { x: 0.5, y: 0.5 }, layout: 'row', gap: 0.05 },
    { id: 'middle', anchor: { x: 0.5, y: 0.5 }, layout: 'pile' },
    { id: 'discard', anchor: { x: 0.85, y: 0.8 }, layout: 'pile', label: 'Discard', labelPos: 'above' },
  ],
  ...
  steps: [
    ...
    // ---------- Round 1: singles, and why you might pass ----------
    {
      ...
      callout: 'Small-set rule: on singles and pairs you may also play the exact same rank, not only a higher one — a 9 can answer a 9. (Triples and bigger must be beaten outright.)',
    ...
    },
    {
      ...
      stagger: ['middle'],
      narration:
        'With West already the Bum, the other two play on for the places in between. North empties their hand into the middle and goes out — that’s second place, the Vice-President.',
    ...
    },
    {
      ...
      stagger: ['middle'],
      narration:
        'East lays their last cards down right after — third place, the Vice-Bum. That settles every seat at the table.',
    ...
    },
    {
      ...
      status: { 'p-south': 'Prez' },
      narration:
        'And around it goes, hand after hand. Win and you keep the comfy chair, the title, and the trade in your favour; finish last and you shuffle, deal, and surrender your best cards every time. Empty your hand first — long live the President.',
      apply: (b) => b,
      spotlight: ['p-south'],
    },
  ],
  notes: [
    ...
    },
    {
      ...
      body: 'Some go further: a revolution doesn’t just clear the table, it turns the entire ranking upside-down for the rest of the hand — suddenly the 3 is high and the 2 is low. A dramatic leveller that can break a runaway President’s streak.',
    },
    {
      heading: 'Passing',
